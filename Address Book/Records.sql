create database address_book; --Database Creation
use address_book;


create table AddressBook(    -- Create Table
...
Delete from AddressBook Where FirstName = 'Sohan' --Delete by Particular Name
